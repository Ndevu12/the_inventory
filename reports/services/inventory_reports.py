...
class InventoryReportService:
    ...
    def get_availability_report(
        ...
        *,
        ...
        reserved_qs = (
            StockReservation.objects
            .filter(status__in=self.ACTIVE_RESERVATION_STATUSES)
            .values("product_id")
    ...
    def get_reserved_stock_value(self) -> Decimal:
    ...
    def get_variance_summary(
        ...
        *,
        ...
        """
        qs = InventoryVariance.objects.all()
        if cycle_id is not None:
            qs = qs.filter(cycle_id=cycle_id)
    ...
    def get_lot_history(self, product: Product, lot_number: str):
    ...
    def get_product_traceability(
        ...
        *,
        ...
        try:
            lot = StockLot.objects.select_related("supplier").get(
                product=product,
